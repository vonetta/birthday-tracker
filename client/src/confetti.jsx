...
class Confetti extends Component {
    componentDidMount() {
        ...
        *******************************************************************/
        ...
        drawCircle2 = function (a, b, c, d) {
            context.beginPath();
            context.moveTo(a, b);
            context.lineTo(a + 3, b + 9);
            context.lineTo(a + 9, b);
            context.lineTo(a + 3, b - 9);
            context.closePath();
            context.fillStyle = d;
            return context.fill()
        ...
        Confetti = function () {
            ...
            a.prototype.replace = function () {
                ...
                this.y = range(0, window.h - this.r2);
                this.xmax = window.w - this.r;
                this.ymax = window.h - this.r;
                this.vx = range(0, 1) + 4 * xpos - 0;
            ...
            a.prototype.draw = function () {
                ...
                drawCircle3(0.2 * ~~this.x, ~~this.y, this.r, this.rgb + "," + this.opacity + ")");
                return drawCircle2(1 * ~~this.x, 1.5 * ~~this.y, this.r, this.rgb + "," + this.opacity + ")")
            };
            return a
        }();
        confetti = function () {
    ...
    render() {
        ...
        return (
            <div className="row">
                <canvas id="confetti" width="300" height="300"></canvas>
            </div>
        )
    }
}
