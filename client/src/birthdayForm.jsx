                        ...
                        <form>
                            <div className="row">
                                <div className="input-field col m3">
                                    <div className="input-group date">
                                        <DateTime
                                            value={this.state.form.selectedDate || this.props.eventData}
                                            input={true}
                            ...
                            <div className="row">
                                <div className="input-field col m12">
                                    ...
                                    <input type="email" name="email" id="email" ref={ref => (this.emailElement = ref)} onChange={this.handleChange} value={this.state.form.email} />
                                </div>
                            </div>
                            <div className="row">
