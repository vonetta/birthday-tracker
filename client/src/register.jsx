...
class Register extends Component {
  ...
  submit = () => {
    ...
    if (!this.registerFormElement.checkValidity()) {
      return
    } else {
      create(this.state.register)
        .then(
          data => this.createNotification("success"),
    ...
    return (
      <div>
        ...
        <div className="container">
          <div className="row">
            <form
              className="registerForm m5"
              ref={ref => (this.registerFormElement = ref)}
            >
              ...
              <div className={"row " + this.validityCheck("firstNameElement")}>
                <div className="input-field col m12">
                  ...
                  {this.state.submitted &&
                    ...
                    this.firstNameElement.validity.valueMissing && (
